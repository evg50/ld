...
# # # ---------------------------------------------------------
# # # TAP MARCH WITH WAITING FOR IDLE
# # # ---------------------------------------------------------
# # def tap_march():
...
# #                 # --- NEW: check if correct troop is selected ---
...
# #                     print("Troop not selected, selecting troop...")
# #                     tap(DEVICE_ID, 500, 500)   # координаты твоего отряда
# #                     time.sleep(0.7)
# #                     take_screenshot(DEVICE_ID)
...
# #         print("Idle not detected within 30 seconds, restarting cycle")
# #         return False
...
# #     if check_area_xyxy(
# #         SCREENSHOT_PATH,
# #         os.path.join(BASE_DIR, "templates/search_button.png"),
# #         (3, 740, 60, 800),
# #         0.5
# #     ):
# #         time.sleep(1)
